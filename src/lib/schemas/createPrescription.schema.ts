...
export const createPrescriptionSchema = yup.object().shape({
  ...
  chronic_conditions: yup.string().optional(),
  drug_allergies: yup.string().optional(),
...
export type TCreatePrescriptionFormValues = yup.InferType<typeof createPrescriptionSchema>;
