...
export const MedicationsStepForm: React.FC = () => {
            ...
            <View style={{ flex: 1, marginRight: 10 }}>
              ...
              <View style={{ flexDirection: 'row' }}>
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <TextInput
                      style={[S.consultInput, { flex: 1, borderTopRightRadius: 0, borderBottomRightRadius: 0 }]}
                      placeholder="50"
                      placeholderTextColor={theme.colors.textMuted}
                      value={value || ''}
                      onChangeText={onChange}
          ...
          <View style={S.vitalsRow}>
            <View style={{ flex: 1, marginRight: 10 }}>
              ...
              <View style={{ flexDirection: 'row' }}>
                ...
                <TouchableOpacity
                  style={S.unitSelectBtn}
                  onPress={() => openPicker(index, 'durationUnit', 'Select Duration Unit', DURATION_UNITS)}
                >
                  <Text style={S.unitSelectText}>
...
export default MedicationsStepForm;
